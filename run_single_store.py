...
async def tracked_main():
    # We need to wrap the internal category loop in main.py
    # Since main.py loop is inside async main(), we patch the scrape_category_all_pages
    original_scrape = main.scrape_category_all_pages
    ...
    main.scrape_category_all_pages = wrapped_scrape
