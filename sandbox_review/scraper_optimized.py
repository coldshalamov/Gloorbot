...
from playwright.async_api import async_playwright, Page, Locator, Route
...
async def scrape_category_page(page: Page, url: str, store_info: dict, page_num: int = 1) -> list[dict]:
    ...
    await asyncio.sleep(0.5)  # 1.5-3.9 seconds (30% inc)
    ...
    await asyncio.sleep(0.5)  # 2.0-4.55 seconds (30% inc) after page load
    ...
    await asyncio.sleep(0.5)  # 1.5-3.25 seconds (30% inc) before scraping
                ...
                try:
                    ...
                    for idx, category_url in enumerate(categories):
                        try:
                            ...
                            await asyncio.sleep(0.5)  # 2.0-4.55 sec (30% inc) between categories
